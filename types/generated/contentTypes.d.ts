...
export interface ApiHouseHouse extends Schema.CollectionType {
  ...
  attributes: {
    house_id: Attribute.String & Attribute.Required;
    date: Attribute.Date;
    price: Attribute.BigInteger & Attribute.Required;
    bedrooms: Attribute.Integer;
    bathrooms: Attribute.Integer;
    sqft_living: Attribute.Integer;
    sqft_lot: Attribute.Integer;
    floors: Attribute.Float;
    waterfront: Attribute.Boolean;
    view: Attribute.Integer;
    condition: Attribute.Integer;
    grade: Attribute.Integer;
    sqft_above: Attribute.Integer;
    sqft_basement: Attribute.Integer;
    yr_built: Attribute.Integer;
    yr_renovated: Attribute.Integer;
    zipcode: Attribute.Integer;
    lat: Attribute.Float;
    long: Attribute.Float;
    sqft_living15: Attribute.Integer;
    sqft_lot15: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
